...
public final class AttributesAttachment {
    ...
    private static Map<ResourceLocation, EnumSet<RefreshKey>> createAttributeToRefreshMap() {
        ...
        map.put(attrKey(JolCraftAttributes.MOVEMENT_SPEED_DAY_INCREASE), EnumSet.of(RefreshKey.SKYBURROW));
        map.put(attrKey(JolCraftAttributes.MOVEMENT_SPEED_NIGHT_INCREASE), EnumSet.of(RefreshKey.MOONSHARD));

...
public final class JolCraftItemPropertyIds extends JolCraftIds {
    ...
    // Item tint sources
    public static final String DEEPSLATE_COMPASS_DIAL_COLOR = JolCraftDataComponentIds.DEEPSLATE_COMPASS_DIAL_COLOR;
    public static final String BREW_COLOR = JolCraftDataComponentIds.BREW_COLOR;
}

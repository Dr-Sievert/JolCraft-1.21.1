...
public final class JolCraftAdvancementIds extends JolCraftIds {
    ...
    // ---------------------------------------------------------------------
    // Reputation / progression scaffolding
    // ---------------------------------------------------------------------

    public static final String REP_0_DUMMY = join(JolCraftDictionary.REPUTATION,  DwarvenReputationTier.STRANGER.idToString(), JolCraftDictionary.DUMMY);
    ...
    public static final String REP_1 = join(JolCraftDictionary.REPUTATION, DwarvenReputationTier.KNOWN_FACE.idToString());
    public static final String REP_1_DUMMY = join(JolCraftDictionary.REPUTATION, DwarvenReputationTier.KNOWN_FACE.idToString(), JolCraftDictionary.DUMMY);
    ...
    public static final String REP_2 = join(JolCraftDictionary.REPUTATION, DwarvenReputationTier.TRUSTED.idToString());
    public static final String REP_2_DUMMY = join(JolCraftDictionary.REPUTATION, DwarvenReputationTier.TRUSTED.idToString(), JolCraftDictionary.DUMMY);
    ...
    public static final String REP_3 = join(JolCraftDictionary.REPUTATION, DwarvenReputationTier.RESPECTED.idToString());
    public static final String REP_3_DUMMY = join(JolCraftDictionary.REPUTATION, DwarvenReputationTier.RESPECTED.idToString(), JolCraftDictionary.DUMMY);
    ...
    public static final String REP_4 = join(JolCraftDictionary.REPUTATION, DwarvenReputationTier.BLOOD_KIN.idToString());
    public static final String REP_4_DUMMY = join(JolCraftDictionary.REPUTATION, DwarvenReputationTier.BLOOD_KIN.idToString(), JolCraftDictionary.DUMMY);

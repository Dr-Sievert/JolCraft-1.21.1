...
import net.sievert.jolcraft.recipe.custom.input.LapidaryRecipeInput;
...
public class LapidaryBenchBlockEntity extends BaseContainerBlockEntity  {
    ...
    public void handleAction(ServerPlayer player, int actionId) {
        ...
        if (toolType == LapidaryBenchRecipe.ToolType.CHISEL
            ...
            player.displayClientMessage(
                    Component.translatable("tooltip.jolcraft.lapidary_bench.locked_cut_gems")
    ...
    protected Component getDefaultName() {
        return Component.translatable("container.jolcraft.lapidary_bench");
    }

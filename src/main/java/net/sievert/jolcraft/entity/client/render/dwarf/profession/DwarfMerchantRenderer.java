...
import net.sievert.jolcraft.entity.custom.dwarf.profession.EntityMerchantEntity;
import org.jetbrains.annotations.NotNull;

@OnlyIn(Dist.CLIENT)
public class DwarfMerchantRenderer extends DwarfRenderer<EntityMerchantEntity> {

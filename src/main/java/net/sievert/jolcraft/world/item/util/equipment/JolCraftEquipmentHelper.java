...
public final class JolCraftEquipmentHelper {
    ...
    public enum ArmorPiece {
        HELMET("helmet", EquipmentSlot.HEAD, ArmorType.HELMET),
        CHESTPLATE("chestplate", EquipmentSlot.CHEST, ArmorType.CHESTPLATE),
        LEGGINGS("leggings", EquipmentSlot.LEGS, ArmorType.LEGGINGS),
        BOOTS("boots", EquipmentSlot.FEET, ArmorType.BOOTS);

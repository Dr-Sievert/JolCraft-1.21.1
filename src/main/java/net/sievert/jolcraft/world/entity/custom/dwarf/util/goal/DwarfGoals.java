package net.sievert.jolcraft.world.entity.custom.dwarf.util.goal;
...
import net.sievert.jolcraft.world.entity.custom.ai.goal.dwarf.DwarfAttackGoal;
import net.sievert.jolcraft.world.entity.custom.ai.goal.dwarf.DwarfBlockGoal;
import net.sievert.jolcraft.world.entity.custom.ai.goal.dwarf.DwarfBreedGoal;
import net.sievert.jolcraft.world.entity.custom.ai.goal.dwarf.DwarfFollowParentGoal;
import net.sievert.jolcraft.world.entity.custom.ai.goal.dwarf.DwarfLookAtTradingPlayerGoal;
import net.sievert.jolcraft.world.entity.custom.ai.goal.dwarf.DwarfNonPlayerAlertGoal;
import net.sievert.jolcraft.world.entity.custom.ai.goal.dwarf.DwarfRevengeGoal;
import net.sievert.jolcraft.world.entity.custom.ai.goal.dwarf.DwarfTradeWithPlayerGoal;
import net.sievert.jolcraft.world.entity.custom.ai.goal.dwarf.DwarfUseItemGoal;
import net.sievert.jolcraft.world.entity.custom.ai.goal.dwarf.FirePanicGoal;

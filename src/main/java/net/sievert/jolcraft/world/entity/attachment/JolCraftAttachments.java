package net.sievert.jolcraft.world.entity.attachment;
...
import net.sievert.jolcraft.world.entity.attachment.player.custom.compass.DiscoveredStructuresAttachment;
import net.sievert.jolcraft.world.entity.attachment.player.custom.hearth.HearthAttachment;
import net.sievert.jolcraft.world.entity.attachment.player.custom.language.LanguageAttachment;
import net.sievert.jolcraft.world.entity.attachment.player.custom.lore.DwarfLoreAttachment;
...
public final class JolCraftAttachments {
    ...
    public static final Supplier<AttachmentType<LanguageAttachment>> LANGUAGE =
            ATTACHMENT_TYPES.register(
                    JolCraftAttachmentIds.LANGUAGE,
    ...
    public static final Supplier<AttachmentType<Float>> OVERHEAL =
            ATTACHMENT_TYPES.register(
                    JolCraftAttachmentIds.OVERHEAL,

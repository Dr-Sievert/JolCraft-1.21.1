...
public final class JolCraftLootTables {
    ...
    public static final class Chests {
        ...
        public static final ResourceKey<LootTable> DWARVEN_LEXICON_IN_STRONGHOLD_LIBRARY =
                chest(inject(register(JolCraftLootTableIds.DWARVEN_LEXICON_IN_STRONGHOLD_LIBRARY)));

        public static final ResourceKey<LootTable> DWARVEN_LEXICON_IN_ABANDONED_MINESHAFT =
                chest(inject(register(JolCraftLootTableIds.DWARVEN_LEXICON_IN_ABANDONED_MINESHAFT)));

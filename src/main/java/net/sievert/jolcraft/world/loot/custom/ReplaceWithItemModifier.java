...
public class ReplaceWithItemModifier extends LootModifier {
    ...
    public static final MapCodec<ReplaceWithItemModifier> CODEC =
            RecordCodecBuilder.mapCodec(inst ->
                    ...
                    ).apply(inst, ReplaceWithItemModifier::new)
            );

    private final Holder<Item> item;
    private final float chance;

    public ReplaceWithItemModifier(LootItemCondition[] conditionsIn, Holder<Item> item, float chance) {
        super(conditionsIn);
        this.item = item;

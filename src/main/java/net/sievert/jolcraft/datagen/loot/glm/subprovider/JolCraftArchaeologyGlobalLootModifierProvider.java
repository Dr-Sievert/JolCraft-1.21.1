...
public final class JolCraftArchaeologyGlobalLootModifierProvider implements JolCraftSubDataProvider<JolCraftGlobalLootModifierProvider> {

    private final JolCraftGlobalLootModifierProvider parent;

    public JolCraftArchaeologyGlobalLootModifierProvider(@NotNull JolCraftGlobalLootModifierProvider parent) {
        this.parent = parent;
    }
    ...
    public @NotNull String id() {
        return JolCraftStrings.underscored(
                JolCraftDictionary.ARCHAEOLOGY,

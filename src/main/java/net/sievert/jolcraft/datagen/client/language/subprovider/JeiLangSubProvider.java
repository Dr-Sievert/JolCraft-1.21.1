...
public final class JeiLangSubProvider implements LanguageSubProvider {
    ...
    public void addTranslations(@NotNull Map<String, String> translations) {
        ...
        putManual(translations, JolCraftLanguageKeys.JEI_CATEGORY_MORTAR, "Mortar");
        putManual(translations, JolCraftLanguageKeys.JEI_CATEGORY_CORRUPTION, "Potion Corruption");
        putManual(translations, JolCraftLanguageKeys.JEI_MORTAR_GRINDING_WORK, "Grinding Work: %s");
        ...
        putManual(translations, JolCraftLanguageKeys.JEI_TOOLTIP_CHANCE_ROLL, "Chance per trade roll: %s");
        putManual(translations, JolCraftLanguageKeys.JEI_TOOLTIP_CHANCE_LEVEL, "Chance to get trade at this level: %s");
        putManual(translations, JolCraftLanguageKeys.JEI_TOOLTIP_CHANCE_TOTAL, "Chance to get trade at max level: %s");

package net.sievert.jolcraft.datagen.recipe.builder.custom.fermenting_cauldron;
 ...
 *
 * Updated to match the current recipe shape:
 * - lastIngredient / extract / effect are optional fields
 * - effect has no EMPTY sentinel
 */
...
public final class FermentingCauldronRecipeBuilder implements RecipeBuilder {
    ...
    private @Nullable EffectOutput effect;
    ...
    public @NotNull FermentingCauldronRecipeBuilder effect(@Nullable EffectOutput eff) {
        if (eff == null) {
            errors.add("effect is null (treated as absent)");
            this.effect = null;
            return this;
        }
        this.effect = eff;
    ...
    public @NotNull DataResult<RecipeEmission> buildValidated() {
        ...
        FermentingCauldronRecipe recipe = new FermentingCauldronRecipe(
                ...
                hasLast ? Optional.of(lastIngredient) : Optional.empty(),
                hasExtract ? Optional.of(extract) : Optional.empty(),
    ...
    private String tokenFromEffectFailClosed(@Nullable EffectOutput eff) {
        if (eff == null) {
